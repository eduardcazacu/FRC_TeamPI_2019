...
{
    _i2c->Write(ina219_i2caddr,reg);                       // Register
    _i2c->Write(ina219_i2caddr,(value >> 8) & 0xFF);       // Upper 8-bits
    _i2c->Write(ina219_i2caddr,value & 0xFF);              // Lower 8-bits
}
...
{
    uint8_t buffer[2];
    _i2c->Read(reg,2,buffer);                        // Register
